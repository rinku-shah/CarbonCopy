...
def writeTunnelRules(p4info_helper, ingress_sw, tunnel_id,
                     key, value):
    """
    ...
    table_entry = p4info_helper.buildTableEntry(
        table_name="c_ingress.kv_store",
        match_fields={
            "hdr.data.key1": (key, 32)
        },
        action_name="c_ingress.reply_to_read",
        action_params={
            "value": value,
        })
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        s1.MasterArbitrationUpdate() # set local controller as master
